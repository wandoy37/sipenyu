        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" @if (old('jenis_kelamin', @$pegawai->jenis_kelamin) == 'Laki-Laki') checked @endif
                            @if (!isset($peserta)) checked @endif type="radio" name="jenis_kelamin"
                            value="Laki-Laki" id="flexRadioDefault1" />
                        <label class="form-check-label" for="flexRadioDefault1">
                            Laki-Laki
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" @if (old('jenis_kelamin', @$pegawai->jenis_kelamin) == 'Perempuan') checked @endif
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="08..." type="text" name="no_wa"
                        value="{{ old('no_wa', @$pegawai->no_wa) }}" minlength="1" maxlength="20" />
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @enderror
                    <textarea class="form-control" rows="4" id="alamat_rumah" placeholder="Jl.Jalan-jalan..." name="alamat_rumah">{{ old('alamat_rumah', @$pegawai->alamat_rumah) }}</textarea>
                </div>
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Pendidikan Terakhir..." type="text"
                        ...
                        value="{{ old('pendidikan_terakhir', @$pegawai->pendidikan_terakhir) }}" maxlength="100" />
                </div>
                <div class="form-group">
                    <label>
                        Agama
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    @enderror
                    <input class="form-control" placeholder="Nama Jabatan..." type="text" name="nama_jabatan"
            ...
            <div class="col-md-6">
                ...
                @if (isset($pegawai))
                    <div class="form-group">
                        ...
                        @enderror
                        <input class="form-control" placeholder="Password Baru..." type="password"
                            name="password_baru" minlength="5" />
                    </div>
                @else
                    <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                @if (isset($pegawai) && $pegawai->link_foto_profil != null)
                    <img src="{{ $pegawai->link_foto_profil }}" alt="foto kegiatan" class="img-fluid">
                @endif
            </div>
            <div class="col-md-6">
                ...
                <label class="dropzone" id="dropzone_foto_spt">
                    <h4>Drop & Drag File</h4>
                    <p>Drag and drop file here or click to select file.</p>
                    <input type="file" name="foto_spt" id="foto_spt" style="display: none;" accept="image/*">
                ...
                @if (isset($pegawai) && $pegawai->link_foto_spt != null)
                    ...
                    <div id="old_foto_spt">
                        <input type="hidden" name="old_foto_spt" value="{{ $pegawai->link_foto_spt }}">
                        <img src="{{ $pegawai->link_foto_spt }}" alt="foto kegiatan" class="img-fluid">
                    </div>
                @endif
            </div>
        </div>
...
@push('scripts')
    <script>
        $('#select_pangkat_golongan').select2({
            theme: "bootstrap"
        });
    </script>
    <script type="module">
